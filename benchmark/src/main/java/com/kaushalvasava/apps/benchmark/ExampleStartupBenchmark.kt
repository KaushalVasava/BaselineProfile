package com.kaushalvasava.apps.benchmark
...
class ExampleStartupBenchmark {
    ...
    fun startup() = benchmarkRule.measureRepeated(
        packageName = "com.kaushalvasava.apps.benchmarkprofile",
...
//        d evice.wait(Until.hasObject(By.text("Detail: Element 29")), 1000)
    }
}